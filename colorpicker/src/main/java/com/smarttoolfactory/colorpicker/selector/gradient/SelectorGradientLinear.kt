...
@Composable
internal fun LinearGradientSelection(size: Size, onGradientOffsetChange: (GradientOffset) -> Unit) {
...
@Composable
private fun GradientOffsetSelection(size: Size, onGradientOffsetChange: (GradientOffset) -> Unit) {
...
@Composable
private fun GradientOffsetTypeSelection(size: Size, onGradientOffsetChange: (GradientOffset) -> Unit) {
    val gradientOffsetOptions =
        if (size != Size.Zero) {
...
@Composable
private fun GradientOffsetPositionSelection(size: Size, onGradientOffsetChange: (GradientOffset) -> Unit) {
...
@Composable
private fun GradientOffsetAngleSelectionSlider(onGradientOffsetChange: (GradientOffset) -> Unit) {
    ...
    Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
        ...
        Slider(
            ...
            onValueChange = {
                ...
                gradientOffset =
                    when (angleSelection.roundToInt()) {
                        0 -> {
                            angleText = "0°"
